...
>  **Note:**  `sudo` was required here due to kernel header access, this may vary depending on your system's BPF permissions.
...
>  **Note**: The *fileless case* is the more dangerous as no file ever touches disk, making it nearly invisible to traditional AV/EDR solutions. For this, a better output for our Ebpf may help us identify a LOLbin attack, and that's by adding PPID to the output.
